...
export class HomeTrasportiPage extends MainPage implements OnInit {
  ...
  constructor(private router: Router, private transportService: TransportService, private loadingController: LoadingController, public override translate: TranslateService, private dbService: DbService, private config: ConfigService) {
    super(translate);
