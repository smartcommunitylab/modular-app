...
import { NavController, AlertController, PopoverController, ModalController, Platform } from '@ionic/angular';
...
export class ListFarmaciePage implements OnInit {
  showPois: any = [];
  fullPois: any = [];
  language: string;
  category: any;
  ...
  constructor(
    ...
    this.events.subscribe('radio:selected', x => {
