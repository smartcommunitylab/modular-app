...
export class HomePage extends MainPage {
  ...
  pois: any = [];
  override language: string = "it";
  elementsGalleryStr: string;
  constructor(public override navCtrl: NavController, public override translate: TranslateService, private config: ConfigService, private router: Router, public dbService: DbService, public alertCtrl: AlertController) {
