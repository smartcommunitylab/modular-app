...
function createComponentOnReadyPrototype(win, namespace, HTMLElementPrototype) {
  ...
  })(window, document, "mycomponent","mycomponent",0,"mycomponent.core.js","es5-build-disabled.js","hydrated","ion-col,ion-content,ion-icon,ion-row,wc-trasporti-map,wc-trasporti-stop,wc-trasporti-table",HTMLElement.prototype);