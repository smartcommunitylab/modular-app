...
function r(n, t, e) { void 0 === e && (e = {}); var r = Array.isArray(t) ? t : [t], i = n.document, o = e.hydratedCssClass || "hydrated", u = e.exclude; u && (r = r.filter(function (n) { return -1 === u.indexOf(n[0]); })); var c = r.map(function (n) { return n[0]; }); if (c.length > 0) {
    ...
    mycomponent_global_js_1.default(s, u, n, i, c, o), H[s] = F(s, u, n, i, c, o, r);
...
var mycomponent_global_js_1 = require("./mycomponent.global.js");
...
var c = "$", a = {}, s = { enter: 13, escape: 27, space: 32, tab: 9, left: 37, up: 38, right: 39, down: 40 }, l = function (t, e, r, i) { var o = r.t + c, u = r[o]; if ((2 === r.G || 1 === r.G && !t.Z.Y) && (i["s-sc"] = u ? n(r, i.mode) : n(r)), u) {
    ...
    } _(m, t, f); }); }, Cn: !1, wn: !1, st: !1, An: l, Mn: new WeakMap, K: new WeakMap, Nn: new WeakMap, ot: new WeakMap, vt: new WeakMap, ct: new WeakMap, _n: new WeakMap, jn: new WeakMap, gn: new WeakMap, mn: new WeakMap, bn: new WeakMap, lt: new WeakMap, Pn: new WeakMap, On: new WeakMap, Sn: new WeakMap, yn: new Set, Rn: [] }; return t.isServer = t.isPrerender = !(t.isClient = !0), t.window = r, t.location = r.location, t.document = i, t.resourcesUrl = t.publicPath = o, t.enableListener = function (n, t, e, r, i) { return function o(n, t, e, r, i, u) { if (t) {
    ...
    if (y = w.i = j || "svg" === w.vtag ? t.Fn("http://www.w3.org/2000/svg", w.vtag) : t.V(w.pt ? "slot-fb" : w.vtag), n.ft(y) && n.ct.delete(c), j = "svg" === w.vtag || "foreignObject" !== w.vtag && j, M(n, null, w, j), v(r) && y["s-si"] !== r && t.En(y, y["s-si"] = r), w.vchildren)
    ...
    n.st = !1;
} return i && w(l.i), m.length = 0, l; }; }(m, y), b["s-ld"] = [], b["s-rn"] = !0, b["s-init"] = function () { m.ct.set(b, d.loaded = m.wn = !0), y.et(r, "appload", { detail: { namespace: n } }); }, function (n, t, e, r, i, o) { if (t.componentOnReady = function (t, e) { if (!t.nodeName.includes("-"))
