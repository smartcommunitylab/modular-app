...
var CACHED_MAP, win = window, SUPPORTS_VARS = !!(win.CSS && win.CSS.supports && win.CSS.supports("--a: 0")), BREAKPOINTS = ["", "xs", "sm", "md", "lg", "xl"], Col = function () { function t() { } return t.prototype.onResize = function () { this.el.forceUpdate(); }, t.prototype.getColumns = function (t) { for (var e, n = 0, r = BREAKPOINTS; n < r.length; n++) {
    var i = r[n], o = matchBreakpoint(this.win, i), s = this[t + i.charAt(0).toUpperCase() + i.slice(1)];
    o && void 0 !== s && (e = s);
...
var Icon = function () { function t() { this.isVisible = !1, this.lazy = !1; } return t.prototype.componentWillLoad = function () { var t = this; this.waitUntilVisible(this.el, "50px", function () { t.isVisible = !0, t.loadIcon(); }); }, t.prototype.componentDidUnload = function () { this.io && (this.io.disconnect(), this.io = void 0); }, t.prototype.waitUntilVisible = function (t, e, n) { var r = this; if (this.lazy && this.win && this.win.IntersectionObserver) {
    var i = this.io = new this.win.IntersectionObserver(function (t) { t[0].isIntersecting && (i.disconnect(), r.io = void 0, n()); }, { rootMargin: e });
    i.observe(t);
}
else
...
var Row = function () { function t() { } return t.prototype.render = function () { return mycomponent_core_js_1.h("slot", null); }, Object.defineProperty(t, "is", { get: function () { return "ion-row"; }, enumerable: !0, configurable: !0 }), Object.defineProperty(t, "encapsulation", { get: function () { return "shadow"; }, enumerable: !0, configurable: !0 }), Object.defineProperty(t, "style", { get: function () { return ".sc-ion-row-h{display:-ms-flexbox;display:flex;-ms-flex-wrap:wrap;flex-wrap:wrap}"; }, enumerable: !0, configurable: !0 }), t; }();
exports.IonRow = Row;
